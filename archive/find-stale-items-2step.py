...
## TODO this script assumes the entire directory has the same freshness tier.
# so far, that's true but might not be in the future
# Freshness tiers can be set in the document metadata in the ms-collection section:
# ce-skilling-fresh-tier0 = 90
# ce-skilling-fresh-tier1 = 180
# ce-skilling-fresh-tier2 = 365
# when we have a mix, will need revise to take into account.
